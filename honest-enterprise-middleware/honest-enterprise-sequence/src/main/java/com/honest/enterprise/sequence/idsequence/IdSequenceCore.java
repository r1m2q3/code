 ...
 * @author fanjie
 */
public final class IdSequenceCore {
    ...
    public IdSequenceCore(long dataCenterId) {
        this(dataCenterId, 0x000000FF & getLastIPAddress(), false, 5L, false);
    }

    public IdSequenceCore(long dataCenterId, boolean clock, boolean randomSequence) {
     ...
     */
    public IdSequenceCore(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
