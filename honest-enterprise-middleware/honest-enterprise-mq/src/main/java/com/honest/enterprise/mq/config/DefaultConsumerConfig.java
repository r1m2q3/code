...
public  class DefaultConsumerConfig {
    ...
    public DefaultMQPushConsumer defaultConsumer()  throws MQClientException {
        ...
        consumer.registerMessageListener(new MessageListenerConcurrently() {
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
                return DefaultConsumerConfig.this.onMessage(msgs);
            }
        });
        ...
        for(Map.Entry<String, Object> entry : consumeMap.entrySet()){
            ...
            if(!strategyClass.getAnnotation(AnnMqTopic.class).messageModel().equals(MessageModel.CLUSTERING)){
                continue;
            }
    ...
    public ConsumeConcurrentlyStatus onMessage(List<MessageExt> msgs){
        for (MessageExt msg : msgs) {
            ...
            //分布式锁
            RLock lock= redissonClient.getLock(topicTag + ":" + msg.getMsgId());
            try {
                ...
                if (serviceBean instanceof MqConsumerService) {
                    ...
                    if(lock.tryLock()) {
                        ...
                        log.info("onMessage get lock fail!");
